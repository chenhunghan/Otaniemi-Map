...
/***/ function(module, exports, __webpack_require__) {
	...
	var _d3 = __webpack_require__(9);
	
	var _d32 = _interopRequireDefault(_d3);
	
	var _topojson = __webpack_require__(10);
	...
	var zoom = 3000;
	var projection = _d32["default"].geo.mercator().translate([-1850 - 350.98 * zoom, 8000 + 1072.02 * zoom]).scale(5500 + 810 * zoom);
	
	var path = _d32["default"].geo.path().projection(projection);
	
	_d32["default"].json("json/map.topojson", function (error, json) {
	    var featureCollection = _topojson2["default"].feature(json, json.objects.map);
	    svg.append("g").selectAll('path').data(featureCollection.features).enter().append("path").attr("d", path).attr('class', function (d, i) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".mappoint {\n    fill: rgba(255,0,0,0.1);\n}\n.mappath {\n    fill: none;\n    stroke: black;\n    stroke-width:0.3px;\n}\n\n.hide {\n    opacity: 0;\n}\n", ""]);
